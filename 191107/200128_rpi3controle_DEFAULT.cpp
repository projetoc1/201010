...
int main()
{
    ...
    while(1)
    {
        ...
        printf("aileron = %6.2f profundor = %6.2f leme = %6.2f manete = %6.2f h = %6.2f h_ref = %6.2f v = %6.2f v_ref = %6.2f\n",comando_aileron,interconexao,comando_leme,v_pi,h,h_ref,v,v_ref);
