...
int main()
{
    ...
    printf("Nextion_out\n");
    FILE *h_v_table;
    h_v_table = fopen("200413_trajetoria1v2.txt","r");
    ...
    while(1)
    {
        ...
        if(modo_pm_pa == 1) //PA
        {
            ...
            if(segundos - tempo_pa_ativo > 60)
            {
                tempo_traj = segundos - tempo_pa_ativo - 60;
                //fscanf(h_v_table,"%f,%f",&h_traj,&v_traj);
                h_traj = -0.000189179827128*tempo_traj*tempo_traj + 1.691781317783000*tempo_traj - 23.824273717931600;
                v_traj = -0.000000000000000000090788995371*tempo_traj*tempo_traj*tempo_traj*tempo_traj*tempo_traj*tempo_traj + 0.00000000000000111384116284984*tempo_traj*tempo_traj*tempo_traj*tempo_traj*tempo_traj - 0.00000000000531980888430202*tempo_traj*tempo_traj*tempo_traj*tempo_traj + 0.0000000125529840170561*tempo_traj*tempo_traj*tempo_traj - 0.0000155589752626195*tempo_traj*tempo_traj + 0.0106140311777381*tempo_traj + 28.6051930982067;
            ...
            //ROTINA PID's
            float batente_h = 100;
            float h_pi = pid_h.calc_pid(h_ref + h_traj, dt, h,batente_h,0);
            ...
            v_ant = v;
            v_pi = pid_v.calc_pid(v_traj, dt, v,batente_v,2); // 2 significa anti windup do integrador será ativado
        ...
        printf("t = %8.2f h = %8.2f h_traj = %8.2f v = %8.2f v_traj = %8.2f\n",segundos - tempo_pa_ativo,h,h_traj,v,v_traj);
        usleep(20000); //50Hz
    }//while thread0
    return 0;
}
