...
void* f_thread1(void* data)
{
    ...
    while(1)
    {
        ...
        // adc2 = ads.ads_read();
        // leitura2 = adc2*VPS;
        // alfa = 508.81*leitura1 - 1277.1;
        // beta = 411.09*leitura2 - 1006.9;
        // BAROMETRO
        ...
        //telemetria advinda do arduino
        // const char* conv2;
        // int byte = serialGetchar(uart);
        // if(byte==-1)
        // {
        // }
        // else
...
void* f_thread2(void* data)
{
    ...
    while(1)
    {
        ...
        else
        {
            ...
            fprintf(texto,"%16.2f%16.2f%16.2f",RPM,alfa,beta);
