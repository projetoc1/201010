...
int main()
{
    ...
    while(1)
    {
        ...
        if(modo_pm_pa == 1) //PA
        {
            ...
            //ROTINA PID's
            float batente_v = 5;
            v_pi = pid_v.calc_pid(v_ref_exp, dt, v,batente_v,2); // 2 significa anti windup do integrador será ativado
        ...
        printf("time_hold_comandado =%8.2f aileron =%8.2f rand = %d\n",segundos - time_hold_comandado,aileron,random(10));
    }//while thread0
    return 0;
}
