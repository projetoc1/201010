...
int main()
{
    ...
    while(1)
    {
        ...
        if(modo_pm_pa == 1) //PA
        {
        	...
        	//SENOIDAL
        	if(segundos - tempo_pa_ativo > 240 && segundos - tempo_pa_ativo < 260)
        	{
        		perturbacao_comando = manobras_seno (240, segundos - tempo_pa_ativo, 10, 10, 0.8);
        	}
        	if(segundos - tempo_pa_ativo > 340 && segundos - tempo_pa_ativo < 360)
        	{
        		perturbacao_comando = manobras_seno (340, segundos - tempo_pa_ativo, 10, 10, 0.8);
        	}
        	if(segundos - tempo_pa_ativo > 440 && segundos - tempo_pa_ativo < 460)
        	{
        		perturbacao_comando = manobras_seno (440, segundos - tempo_pa_ativo, 10, 10, 0.8);
        	}
            ...
            // v_pi            = v_pi + delta_man;
            interconexao    = interconexao + delta_prof;
            comando_aileron = comando_aileron + delta_ail + perturbacao_comando;
