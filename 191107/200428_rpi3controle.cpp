...
int main()
{
    ...
    while(1)
    {
        ...
        if(modo_pm_pa == 1) //PA
        {
            ...
            v_pi = pid_v.calc_pid(v_ref_exp, dt, v_filtrado,batente_v,2); // 2 significa anti windup do integrador será ativado // // colocar + manete do instante zero do PA.


            interconexao = (-v_pi*ganho_interconexao) + theta_e_q; // colocar + interconexão do instante zero do PA.
