...
void* f_thread3(void* data)
{
    ...
    while(1)
    {
        ...
        //printf("fp=%2.0f e pm_pa = %2.0f hr=%5.0f vr=%5.0f\n",flag_piloto_out,modo_pm_pa,h_ref_out,v_ref_out);
        //usleep(200000);
    }
}
...
int main()
{
    ...
    while(1)
    {
        ...
        //printf("aileron = %6.2f profundor = %6.2f leme = %6.2f manete = %6.2f h = %6.2f h_ref = %6.2f h_ref_exp = %6.2f v = %6.2f v_ref = %6.2f flag_nextion %.0f\n",comando_aileron,interconexao,comando_leme,v_pi,h,h_ref,h_ref_exp,v*3.6,v_ref*3.6,flag_piloto_out);
        printf("t = %6.2f time_hold_h = %6.2f h = %6.2f h_ref = %6.2f h_ref_exp = %6.2f h_ref_out %6.2f h_anterior %6.2f delta_h_ref %6.2f\n",segundos,time_hold_h,h,h_ref,h_ref_exp,h_ref_out,h_ref_out_anterior,delta_h_ref);
        //Escrita na serial.
        String telemetria;
