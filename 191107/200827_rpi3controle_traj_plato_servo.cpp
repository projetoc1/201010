...
int main()
{
    ...
    while(1)
    {
        ...
        if(modo_pm_pa == 1) //PA
        {
            ...
            if(segundos - tempo_pa_ativo > 200 && segundos - tempo_pa_ativo < 300)
            {
               tempo_traj_up = segundos - tempo_pa_ativo - 200;
               h_traj = tempo_traj_up;
            }
            if(segundos - tempo_pa_ativo > 400 && segundos - tempo_pa_ativo < 500)
            {
                tempo_traj_down = segundos - tempo_pa_ativo - 400;
                //h_traj = h_traj - tempo_traj_down;
                if(h_traj < 0)
                    h_traj = 0;
            }
            ...
            h_plato = h_ref + h_traj - tempo_traj_down;
        	...
        	if(segundos - tempo_pa_ativo > 225 && segundos - tempo_pa_ativo < 239)
        	{
            	float tempo_atual = segundos - tempo_pa_ativo - 225;
            	v_noisy           = noise_intercept(tempo_atual);
            	v                 = v + v_noisy;
        	}

        	if(segundos - tempo_pa_ativo > 310 && segundos - tempo_pa_ativo < 330)
        	{
            	float tempo_atual = segundos - tempo_pa_ativo - 310;
            	v_noisy           = noise_intercept(tempo_atual);
            	v                 = v + v_noisy;
        	}

        	if(segundos - tempo_pa_ativo > 340 && segundos - tempo_pa_ativo < 360)
        	{
            	float tempo_atual = segundos - tempo_pa_ativo - 340;
            	v_noisy           = noise_intercept(tempo_atual);
            	v                 = v + v_noisy;
        	}

        	if(segundos - tempo_pa_ativo > 370 && segundos - tempo_pa_ativo < 390)
        	{
            	float tempo_atual = segundos - tempo_pa_ativo - 370;
            	v_noisy           = noise_intercept(tempo_atual);
            	v                 = v + v_noisy;
        	}

        	if(segundos - tempo_pa_ativo > 425 && segundos - tempo_pa_ativo < 439)
        	{
            	float tempo_atual = segundos - tempo_pa_ativo - 425;
            	v_noisy           = noise_intercept(tempo_atual);
            	v                 = v + v_noisy;
        	}
            ...
            // delta de comandos            
            // interconexao    = interconexao - 4.723;
            // comando_aileron = comando_aileron + 0.028;

        	//GERANDO PERTURBAÇÕES NA SUBIDA PLATO E DESCIDA
        	//float manobras (float inicio, float tempo, float comandado, float detla_tempo_comandado);
        	//float manobras_seno (float inicio, float tempo, float comandado, float detla_tempo_comandado, float frequencia);
        	//int random(int limite);
        	...
        	//DEGRAU DE COMANDO
        	if(segundos - tempo_pa_ativo > 210 && segundos - tempo_pa_ativo < 230)
        	{
        		perturbacao_comando = manobras(210, segundos - tempo_pa_ativo, 10, 2);
        	}
        	if(segundos - tempo_pa_ativo > 310 && segundos - tempo_pa_ativo < 330)
        	{
        		perturbacao_comando = manobras(310, segundos - tempo_pa_ativo, 10, 2);
        	}
        	if(segundos - tempo_pa_ativo > 410 && segundos - tempo_pa_ativo < 430)
        	{
        		perturbacao_comando = manobras(410, segundos - tempo_pa_ativo, 10, 2);
        	}

        	//SENOIDAL
        	
        	// if(segundos - tempo_pa_ativo > 100 && segundos - tempo_pa_ativo < 140)
        	// {
        	// 	freq_sen = freq_sen + 0.0001;
        	// 	perturbacao_comando = manobras_seno (100, segundos - tempo_pa_ativo, 10, 40, 0.1 + freq_sen);
        	// }
        	// if(segundos - tempo_pa_ativo > 240 && segundos - tempo_pa_ativo < 280)
        	// {
        	// 	freq_sen = (segundos - tempo_pa_ativo - 240)/10;
        	// 	perturbacao_comando = manobras_seno (240, segundos - tempo_pa_ativo, 10, 40, 0.1 + freq_sen);
        	// }
        	// if(segundos - tempo_pa_ativo > 340 && segundos - tempo_pa_ativo < 380)
        	// {
        	// 	freq_sen = (segundos - tempo_pa_ativo - 340)/10;
        	// 	perturbacao_comando = manobras_seno (340, segundos - tempo_pa_ativo, 10, 40,  0.1 + freq_sen);
        	// }
        	// if(segundos - tempo_pa_ativo > 440 && segundos - tempo_pa_ativo < 480)
        	// {
        	// 	freq_sen = (segundos - tempo_pa_ativo - 440)/10;
        	// 	perturbacao_comando = manobras_seno (440, segundos - tempo_pa_ativo, 10, 40,  0.1 + freq_sen);
        	// }
        	
        	printf("%f\n",freq_sen);

        	//RANDOMICO
        	// if(segundos - tempo_pa_ativo > 270 && segundos - tempo_pa_ativo < 290)
        	// {
        	// 	perturbacao_comando = random(10);
        	// }
        	// if(segundos - tempo_pa_ativo > 370 && segundos - tempo_pa_ativo < 390)
        	// {
        	// 	perturbacao_comando = random(10);
        	// }
        	// if(segundos - tempo_pa_ativo > 470 && segundos - tempo_pa_ativo < 490)
        	// {
        	// 	perturbacao_comando = random(10);
        	// }
