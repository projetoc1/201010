...
int main()
{
    ...
    while(1)
    {
        ...
        float cont_ms = 1;
        float leitura_v_aero_loop = 0;
        float divisor = 50;
        // while(cont_ms<=divisor)
        // {
        //     pressao_pitot        = pitot.get_Pressure();
        //     leitura_v_aero_loop  = leitura_v_aero_loop + sqrt((abs(pressao_pitot)/(0.5*1.22501)));
        //     cont_ms++;
        // }
        
        // leitura_v_aero = leitura_v_aero_loop/divisor;
