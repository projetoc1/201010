...
{
  I2Cdev::writeWord(i2cAddress,reg,((value>>8) | (value & 0xFF)));

}

static uint16_t readRegister(uint8_t i2cFd, uint8_t i2cAddress, uint8_t reg) {
  uint16_t reading;
  I2Cdev::readWord(i2cAddress,reg,&reading);
...
*/
/**************************************************************************/
void Adafruit_ADS1015::begin(uint8_t address_id) {
//  printf("setting up ADS with m_i2cAddress = %d\n", m_i2cAddress);
	m_i2cAddress = address_id;
