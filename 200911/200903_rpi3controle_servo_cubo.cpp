...
void interpol(float tempo, float array[])
{
    ...
    else
    {
        ...
        // printf("traj_V[i-1] = %6.2f traj_V[i]  = %6.2f v1 = %6.2f v2 = %6.2f v_out = %6.2f h1 = %6.2f h2 = %6.2f h_out = %6.2f arr0 = %6.2f arr1 = %6.2f\n",traj_V[i-1],traj_V[i],v1,v2,v_out,h1,h2,h_out,arr[0],arr[1]);
...
int main()
{
    ...
    while(1)
    {
        ...
        if(modo_pm_pa == 1) //PA
        {
            ...
            if(segundos - tempo_atualiza_trajetoria >= 60 && flag_trajetoria == 0)
            {
            ...
            if(segundos - tempo_atualiza_trajetoria >= 0)
            {
              ...
              //printf("h: %7.2f h_ref: %7.2f trajetoria : %d h_f %7.2f tempo_atual %7.2f\n",h,h_plato,iotim,h_f, tempo_atual);
