...
int main()
{
    ...
    while(1)
    {
        ...
        if(modo_pm_pa == 1) //PA
        {
            ...
            if(segundos - tempo_pa_ativo > 50 && segundos - tempo_pa_ativo < 100)
            {
               tempo_traj_up = segundos - tempo_pa_ativo - 50;
               h_traj = tempo_traj_up;
            }
            if(segundos - tempo_pa_ativo > 150 && segundos - tempo_pa_ativo < 200)
            {
                tempo_traj_down = segundos - tempo_pa_ativo - 150;
        	...
        	if(segundos - tempo_pa_ativo > 25 && segundos - tempo_pa_ativo < 45)
        	{
            	float tempo_atual = segundos - tempo_pa_ativo - 25;
            	v_noisy           = noise_intercept(tempo_atual);
            	v                 = v + v_noisy;
        	}

        	if(segundos - tempo_pa_ativo > 55 && segundos - tempo_pa_ativo < 75)
        	{
            	float tempo_atual = segundos - tempo_pa_ativo - 55;
            	v_noisy           = noise_intercept(tempo_atual);
            	v                 = v + v_noisy;
        	}

        	if(segundos - tempo_pa_ativo > 155 && segundos - tempo_pa_ativo < 175)
        	{
            	float tempo_atual = segundos - tempo_pa_ativo - 155;
            	v_noisy           = noise_intercept(tempo_atual);
            	v                 = v + v_noisy;
        	}

        	if(segundos - tempo_pa_ativo > 105 && segundos - tempo_pa_ativo < 125)
        	{
            	float tempo_atual = segundos - tempo_pa_ativo - 105;
            	v_noisy           = noise_intercept(tempo_atual);
            	v                 = v + v_noisy;
        	}
