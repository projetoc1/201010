...
float v_aero_filtrado        = 0;
float v_aero_filtrado_ant    = 0;
float v_aero_filtrado_2      = 0;
float v_aero_filtrado_ant_2  = 0;
float v_aero_filtrado_3      = 0;
float v_aero_filtrado_ant_3  = 0;
float v_aero_filtrado_4      = 0;
float v_aero_filtrado_ant_4  = 0;
float v_aero_filtrado_5      = 0;
float v_aero_filtrado_ant_5  = 0;
float v_aero_ant             = 0;
float leitura_v_aero         = 0;
...
// //w varia de 0 a 100 onde :
// //valores próximos a 0 favorecem valores anteriores suavizando a curva
// //valores próximos a 100 favorecem valores novos deixando mais rápida 
// //só que com possível ruído
// float f_exp(float y_antes, float x_agora, float w)
// {
//     return ((w*x_agora)+(1-w)*y_antes);
// }
...
//         v_aero_t  = (int)(3.6*sqrt((abs(pressao_pitot)/(0.5*1.22501))));
//         //v_aero = 20;
//         int alt       = height_msl;
//         int rpm       = 0;
...
//         String telemetria;
//         telemetria+=String("A");
//         telemetria+=String(((v_aero_t)/100)%10);//0
//         telemetria+=String(((v_aero_t)/10)%10);//1
//         telemetria+=String(((v_aero_t)/1)%10);//2
//         telemetria+=",";
...
//     fprintf(texto,"              xI");
//     fprintf(texto,"              zI");
//     fprintf(texto,"       v_aero_f1");
//     fprintf(texto,"       v_aero_f2");
//     fprintf(texto,"       v_aero_f3");
//     fprintf(texto,"       v_aero_f4");
//     fprintf(texto,"       v_aero_f5");
...
//             fprintf(texto,"%16.2f%16.2f%16.2f",Horizontal_acc,Vertial_acc,leitura_v_aero); //gps - precisão horizontal 2d e 3d
...
//             fprintf(texto,"%16.2f",v_aero_filtrado);
//             fprintf(texto,"%16.2f",v_aero_filtrado_2);
//             fprintf(texto,"%16.2f",v_aero_filtrado_3);
//             fprintf(texto,"%16.2f",v_aero_filtrado_4);
//             fprintf(texto,"%16.2f",v_aero_filtrado_5);
...
int main()
{
    ...
    //ADS1115
    ads1.begin(0x48);
    ads1.set_single_channel(4);
    ads2.begin(0x4a);
    ads2.set_single_channel(4);
    ads3.begin(0x4b);
    ads3.set_single_channel(4);
    ...
    while(1)
    {
        ...
        // printf("LSM: roll =%6.2f pitch =%6.2f yaw =%6.2f MPU: roll =%6.2f pitch =%6.2f yaw =%6.2f\n",roll,pitch,yaw,roll1,pitch1,yaw1);
        ...
        // //VALOR FILTRADO
        // axmpu_f = f_passa_baixa(axmpu_f_antes,dt,axmpu_antes,5);
        // axmpu_f_antes=axmpu_f;
        // axmpu_antes=axmpu;
        // aympu_f = f_passa_baixa(aympu_f_antes,dt,aympu_antes,5);
        // aympu_f_antes=aympu_f;
        // aympu_antes=aympu;
        // azmpu_f = f_passa_baixa(azmpu_f_antes,dt,azmpu_antes,5);
        ...
        // //VALOR FILTRADO
        // axlsm_f = f_passa_baixa(axlsm_f_antes,dt,axlsm_antes,5);
        // axlsm_f_antes=axlsm_f;
        // axlsm_antes=axlsm;
        // aylsm_f = f_passa_baixa(aylsm_f_antes,dt,aylsm_antes,5);
        // aylsm_f_antes=aylsm_f;
        // aylsm_antes=aylsm;
        // azlsm_f = f_passa_baixa(azlsm_f_antes,dt,azlsm_antes,5);
        ...
        // leitura_v_aero        = sqrt((abs(pressao_pitot)/(0.5*1.22501)));

        // v_aero_filtrado       = f_passa_baixa(v_aero_filtrado_ant,dt,v_aero_ant,0.5);
        // v_aero_filtrado_ant   = v_aero_filtrado;

        // v_aero_filtrado_2     = f_passa_baixa(v_aero_filtrado_ant_2,dt,v_aero_ant,0.75);
        // v_aero_filtrado_ant_2 = v_aero_filtrado_2;

        // v_aero_filtrado_3     = f_passa_baixa(v_aero_filtrado_ant_3,dt,v_aero_ant,1);
        // v_aero_filtrado_ant_3 = v_aero_filtrado_3;

        // v_aero_filtrado_4     = f_passa_baixa(v_aero_filtrado_ant_4,dt,v_aero_ant,2);
        // v_aero_filtrado_ant_4 = v_aero_filtrado_4;

        // v_aero_filtrado_5     = f_passa_baixa(v_aero_filtrado_ant_5,dt,v_aero_ant,5);
        // v_aero_filtrado_ant_5 = v_aero_filtrado_5;

        // v_aero_ant            = leitura_v_aero;
        ...
        // printf("v_aero =%6.2f", leitura_v_aero);
        printf(" V1 = %10.6f V",leitura1);
        printf(" ADC1 = %5d",adc1);
        printf(" V2 = %10.6f V",leitura2);
        printf(" ADC2 = %5d",adc2);
        printf(" V3 = %10.6f V",leitura3);
        printf(" ADC3 = %5d",adc3);
        // printf(" leitura3 = %6.4f",leitura3);
        printf(" I1 = %10.2f A",250*leitura1/(5*0.06));
        printf(" I2 = %10.2f A",250*leitura2/(5*0.06));
        printf(" I3 = %10.2f A",250*leitura3/(5*0.06));
        printf("\n");
        usleep(100000); //10Hz
